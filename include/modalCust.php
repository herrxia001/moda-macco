...
<!--  header -->
		<div class="modal-header">
			<h5 class="modal-title" id="mkTitle"><?php echo $thisResource->fmCustTitle ?></h5>				
			<button type="button" class="btn btn-secondary ml-2" data-dismiss="modal"><?php echo $thisResource->fmCustBtnClose ?></button>	
			<button type="button" id="mkSave" name="mkSave" class="btn btn-primary ml-2"  onclick="mkDoneCust()"><?php echo $thisResource->fmCustBtnSave ?></button>				
		</div>
<!-- body -->
...
<!-- tabs -->
		<!-- ul class="nav nav-tabs">
			<li class="nav-item">
				<a class="nav-link active" id="mkTabPro" href="#mkTab1" data-toggle="tab"><?php echo $thisResource->fmCustTabPro ?></a>
			</li>
			<li class="nav-item">
				<a class="nav-link" id="mkTabAdd" href="#mkTab2" data-toggle="tab"><?php echo $thisResource->fmCustTab2 ?></a>
			</li>
		</ul -->
<!-- tab content -->
...
<!-- tab1 -->	
		...
		<!-- <hr> -->
<!-- k_id hidden -->
		<input type="number" class="form-control" id="mk_k_id" name="mk_k_id" hidden>
<!-- k_code -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapId ?></span></div>
...
<!-- k_name -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapName ?></span></div>
			<input type="text" class="form-control" id="mk_k_name" name="mk_k_name">
		</div>
<!-- name1 -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapName1 ?></span></div>
			<input type="text" class="form-control" id="mk_name1" name="mk_name1">
		</div>		
<!-- address -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapAddr ?></span></div>
			<input type="text" class="form-control" id="mk_address" name="mk_address">
		</div>
<!-- post -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapPost ?></span></div>
			<input type="text" class="form-control" id="mk_post" name="mk_post">
		</div>
<!-- city -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapCity ?></span></div>
			<input type="text" class="form-control" id="mk_city" name="mk_city">
		</div>
<!-- country -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapCountry ?></span></div>
...
<!-- tel -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapTel ?></span></div>
			<input type="text" class="form-control" id="mk_tel" name="mk_tel">
		</div>
<!-- Ust-IdNo. -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapUstNo ?></span></div>
...
<!-- tab2 -->	
		<div class="tab-pane active" id="mkTab2">
		<!-- <hr> -->
<!-- email -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapEmail ?></span></div>
			<input type="text" class="form-control" id="mk_email" name="mk_email">
		</div>
<!-- WhatsApp -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapWhatsApp ?></span></div>
			<input type="text" class="form-control" id="mk_whatsapp" name="mk_whatsapp">
		</div>
<!-- WeChat -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapWeChat ?></span></div>
			<input type="text" class="form-control" id="mk_wechat" name="mk_wechat">
		</div>
<!-- contact -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapContact ?></span></div>
			<input type="text" class="form-control" id="mk_contact" name="mk_contact">
		</div>
<!-- Tax No. -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapTaxNo ?></span></div>
			<input type="text" class="form-control" id="mk_taxno" name="mk_taxno">
		</div>
<!-- discount -->
		<div class="input-group p-1"> 
			<div class="input-group-prepend"><span class="input-group-text" style="width:100px;"><?php echo $thisResource->fmCustCapDiscount ?></span></div>
